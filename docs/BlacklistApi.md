...
[**is_blacklisted**](BlacklistApi.md#is_blacklisted) | **GET** /phonebook/blacklist/{phone_number} | 
...
# create an instance of the API class
api_instance = phonebook_api.BlacklistApi(phonebook_api.ApiClient(configuration))
phone_number = 'phone_number_example' # str | A phone number

try:
    api_instance.is_blacklisted(phone_number)
except ApiException as e:
